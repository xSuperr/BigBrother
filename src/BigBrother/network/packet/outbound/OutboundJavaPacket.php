...
interface OutboundJavaPacket
{
    ...
    const SYNCHRONIZE_PLAYER_POSITION = 0x39;
    ...
    const SELECT_ADVANCEMENTS_TAB = 0x41;
    ...
    const SET_CENTER_CHUNK_PACKET = 0x48;
    const SET_RENDER_DISTANCE_PACKET = 0x49; // Not used by the dedicated server (Huh?)
    const SPAWN_POSITION_PACKET = 0x4A;
    const SET_DISPLAY_CHAT_PREVIEW_PACKET = 0x4B;
    const DISPLAY_SCOREBOARD_PACKET = 0x4C;
    const SET_DEFAULT_SPAWN_POSITION = 0x4D;
